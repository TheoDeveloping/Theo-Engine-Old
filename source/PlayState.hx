...
class PlayState extends MusicBeatState
{
	...
	override public function create()
	{
		...
		scoreBar.setFormat(Paths.font("vcr.ttf"), 16, FlxColor.WHITE, RIGHT, FlxTextBorderStyle.OUTLINE,FlxColor.BLACK);
	...
	override public function update(elapsed:Float)
	{
		...
		scoreBar.text = "Score : " + scoreCounter + " | Misses : " + missesCounter;
	...
	override function stepHit()
	{
		...
		if (dad.curCharacter == 'tankman' && curStep % 4 == 2)
			{
				// dad.dance();
			}
	}
